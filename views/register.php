  ...
  <div class="container">
    <div class="jumbotron" style="background-color: white;">
      <div class="container text-center">
        <a href="<?php echo $this->config['route']->getAlamatRoot().'?c=c_user&f=loginPage'?>"><img src="assets/img/printkuy.png"></a>
      </div>
    </div>
          ...
          <div class="tab-pane container active col-lg-12" id="pengeprint">
            ...
            <form action="<?php echo $this->config['route']->getAlamatRoot().'?c=c_user&f=registerPengeprint'?>" method="POST">
              ...
              <div class="form-group">
                ...
                <input type="tel"  pattern="^\d{10}$" required class="form-control" id="nohp" name="nohp">
              </div>
              <div class="form-group">
